...
def index_e5_collection(dataset_name, max_id_length, directory, model_name, dim=768):
    """
    Indexes a dataset using E5 query and passage/document encoders with specified parameters.
...
def index_e5_base_collection(dataset_name, max_id_length, directory):
    """
     Indexes a dataset using the 'e5-base-v2' model configuration.
...
def index_e5_base_unsupervised_collection(dataset_name, max_id_length, directory):
    """
    Indexes a dataset using the 'e5-base-unsupervised' model configuration.
...
def index_e5_small_collection(dataset_name, max_id_length, directory):
    """
       Indexes a dataset using the 'e5-small-v2' model configuration, with a 384 dimension.
